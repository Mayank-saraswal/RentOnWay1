...
const SellerEmailOTPVerification = ({ email, backendUrl, onVerificationComplete }) => {
  ...
  const sendEmailOTP = async () => {
    setLoading(true);
    try {
      const response = await axios.post(`${backendUrl}/api/sellers/send-email-otp`, { email });
  ...
  const verifyEmailOTP = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post(`${backendUrl}/api/sellers/verify-email-otp`, {
        email,
        otp: otpString
      });
...
export default SellerEmailOTPVerification; 