...
const DeliveryPartnerEmailOTPVerification = ({ email, backendUrl, onVerificationComplete }) => {
  ...
  const sendEmailOTP = async () => {
    setLoading(true);
    try {
      const response = await axios.post(`${backendUrl}/api/delivery-partners/send-email-otp`, { email });
  ...
  const verifyEmailOTP = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post(`${backendUrl}/api/delivery-partners/verify-email-otp`, {
        email,
        otp: otpString
      });
...
export default DeliveryPartnerEmailOTPVerification; 